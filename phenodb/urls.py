...
urlpatterns = patterns('search.views',
    ...
    url(r'^search/querybuilder/(?P<page>\d+)/(?P<results_per_page>\d+)/(?P<tables_string>\w+)/(?P<wheres_string>\w+)/(?P<where_iss_string>\w+)/(?P<output_string>[:\w]+)/(?P<querystr_string>[\w\.]*)/*$', 'querypage', name="search-querypage"),
